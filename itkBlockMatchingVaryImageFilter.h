 ...
 *
 *=========================================================================*/
#ifndef __itkBlockMatchingVaryImageFilter_h
#define __itkBlockMatchingVaryImageFilter_h
...
namespace itk
{
/** \class BlockMatchingVaryImageFilter
 * \brief Computes displacements of given points from a fixed image in a
 * floating image.
 *
 * BlockMatchingVaryImageFilter takes fixed and moving Images as well as
...
class ITK_EXPORT BlockMatchingVaryImageFilter:
...
public:
  ...
  typedef BlockMatchingVaryImageFilter                                  Self;
  ...
  itkTypeMacro(BlockMatchingVaryImageFilter, MeshToMeshFilter);
...
private:
  ...
  BlockMatchingVaryImageFilter( const BlockMatchingVaryImageFilter & );
  void operator=( const BlockMatchingVaryImageFilter & );
...
#include "itkBlockMatchingVaryImageFilter.hxx"
#endif
